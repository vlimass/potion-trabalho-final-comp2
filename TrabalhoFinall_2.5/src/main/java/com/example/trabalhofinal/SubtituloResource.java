...
@Path("/subtitulo")
public class SubtituloResource {
    @GET
    @Produces("text/html")
    public String subtitulo() {
        String html="<!DOCTYPE html>\n" +
                ...
                "        <title>Adicionar subtítulo</title>\n" +
                //FAVICON:
    ...
    public String htmlForm(){
        String formhtml = " <form method=\"GET\" action=\"adicionar\">\n" +
                "   <div class=\"text\"> <textarea name=\"bloco\" placeholder=\"Insira o subtitulo aqui\" maxlength=\"414\"></textarea> </div>\n" +
                "   <input type=\"hidden\" value=\"h2\" name=\"tipo_bloco\"> \n" +
                "   <div class=\"editar-texto\"> <input type=\"submit\" value=\"Adicionar subtitulo\"> </div>\n" +
                "   </form>";
        return formhtml;
    }
