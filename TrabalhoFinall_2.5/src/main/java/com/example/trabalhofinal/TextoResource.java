...
public class TextoResource {
    ...
    public String htmlForm(){
        String formhtml = "<form method=\"GET\" action=\"adicionar\">\n" +
                "   <div class=\"text\"> <textarea name=\"bloco\" placeholder=\"Insira o texto aqui\" maxlength=\"1050\"></textarea> </div>\n" +
                "   <input type=\"hidden\" value=\"p\" name=\"tipo_bloco\"> \n" +
                "   <div class=\"editar-texto\"> <input type=\"submit\" value=\"Adicionar Texto\"> </div>\n" +
                "   </form>";
        return formhtml;
    }
