...
@Path("/editartextoconteudo")
public class EditarTextoConteudoResource {
    @GET
    @Produces("text/html")
    public String editarTextoConteudo(@QueryParam("novo_texto") @DefaultValue("") String novo_texto, @QueryParam("posicao") @DefaultValue("") String posicao) {
        int int_posicao = Integer.parseInt(posicao);
        try{
            if(PotionApplication.blocos.get(int_posicao).conteudo_bloco.equals(novo_texto)){
                throw new IllegalArgumentException("Texto não alterado.");
            }
            PotionApplication.blocos.get(int_posicao).recebeNovoTexto(novo_texto);
            PotionApplication.blocos.get(int_posicao).blocoToHTML(); // Reconstrói o bloco HTML com o conteúdo do texto editado
            ...
            String html="<!DOCTYPE html>\n" +
                    ...
                    "        <p class=\"first-line\">Conteúdo editado com sucesso!</p>\n" +
            ...
            String html = "<!DOCTYPE html>\n" +
                    ...
                    "        <meta http-equiv= \"X-UA-Compatible\" content = \"IE=edge\">\n" +
                    "        <meta name = \"viewport\" content = \"width=device-width, initial-scale=1.0\">\n" +
                    "        <title>Erro! Conteúdo da anotação já adicionado</title>\n" +
                    //FAVICON:
                    "   <link rel=\"shortcut icon\" href=\"https://media.discordapp.net/attachments/890312701123895377/949731505540845638/icon_2.png\" type=\"image/x-icon\">"+
                    //CSS:
                    "$cssStyle\n" +
                    ...
                    "           <p class=\"first-line\">Esse conteúdo já foi adicionado!</p>\n" +
                    "           <span class=\"buttons\">\n" +
                    "               <a href = \"textoconteudo?posicao="+int_posicao+"\" class=\"first-link\">Voltar</a>" +
