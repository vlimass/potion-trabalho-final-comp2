...
@Path("/blocoremovido")
public class BlocoRemovidoResource {
    @GET
    @Produces("text/html")
    public String blocoRemovido(@QueryParam("posicao") @DefaultValue("") String posicao_bloco) {
        PotionApplication.blocos.remove(Integer.parseInt(posicao_bloco));
        ...
        String html="<!DOCTYPE html>\n" +
                ...
                "       <main>" +
                "    <div class=\"content\">\n" +
                "        <img src=\"https://www.pngrepo.com/png/244047/512/delete-trash.png\" alt=\"Símbolo de Lixeira\">" +
                "        <p class=\"first-line\">Anotação removida!</p>\n" +
