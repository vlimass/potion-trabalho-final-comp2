...
public class LinkResource {
    ...
    public String htmlForm(){
        String formhtml = "<form method=\"GET\" action=\"adicionar\">\n" +
                "   <div class=\"text\"> <input type=\"url\" name=\"bloco\" placeholder=\"Insira o link aqui\" maxlength=\"770\"> </div>\n" +
                "   <input type=\"hidden\" value=\"a\" name=\"tipo_bloco\"> \n" +
                "   <div class=\"editar-texto\"> <input type=\"submit\" value=\"Adicionar link\"> </div>\n" +
                "   </form>";
        return formhtml;
    }
