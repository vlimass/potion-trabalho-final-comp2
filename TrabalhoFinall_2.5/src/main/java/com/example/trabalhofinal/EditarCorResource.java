...
@Path("/editarcor")
public class EditarCorResource {
    @GET
    @Produces("text/html")
    public String editarCor(@QueryParam("cor") @DefaultValue("") String cor, @QueryParam("posicao") @DefaultValue("") String posicao) {
        int int_posicao = Integer.parseInt(posicao);
        try{
            if(PotionApplication.blocos.get(int_posicao).cor_bloco.equals(cor)){
                throw new IllegalArgumentException("Cor já selecionada!");
            }
            PotionApplication.blocos.get(int_posicao).recebeCor(cor);
            PotionApplication.blocos.get(int_posicao).blocoToHTML(); // Reconstrói o bloco HTML com a nova cor selecionada
            ...
            String html="<!DOCTYPE html>\n" +
                    ...
                    "        <title>Cor de fonte editada</title>\n" +
                    //FAVICON:
                    ...
                    "        <p class=\"first-line\">Cor alterada com sucesso!</p>\n" +
            ...
            String html = "<!DOCTYPE html>\n" +
                    ...
                    "        <meta http-equiv= \"X-UA-Compatible\" content = \"IE=edge\">\n" +
                    "        <meta name = \"viewport\" content = \"width=device-width, initial-scale=1.0\">\n" +
                    "        <title>Erro! Cor de fonte já foi selecionada</title>\n" +
                    //FAVICON:
                    "   <link rel=\"shortcut icon\" href=\"https://media.discordapp.net/attachments/890312701123895377/949731505540845638/icon_2.png\" type=\"image/x-icon\">"+
                    //CSS:
                    "$cssStyle\n" +
                    ...
                    "           <p class=\"first-line\">Essa cor já está selecionada!</p>\n" +
                    "           <span class=\"buttons\">\n" +
                    "               <a href = \"cor?posicao="+int_posicao+"\" class=\"first-link\">Voltar</a>" +
