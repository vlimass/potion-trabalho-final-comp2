...
public class TituloResource {
    ...
    public String htmlForm(){
        String formhtml = " <form method=\"GET\" action=\"adicionar\">\n" +
                "   <div class=\"text\"> <textarea name=\"bloco\" placeholder=\"Insira o título aqui\" maxlength=\"245\"></textarea> </div> \n" +
                "   <input type=\"hidden\" value=\"h1\" name=\"tipo_bloco\"> \n" +
                "   <div class=\"editar-texto\"> <input type=\"submit\" value=\"Adicionar título\"> </div>\n" +
                "   </form>";
        return formhtml;
    }
